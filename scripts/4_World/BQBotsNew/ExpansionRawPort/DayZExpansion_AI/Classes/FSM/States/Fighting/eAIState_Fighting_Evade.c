class eAIState_Fighting_Evade: eAIState
{
	...
	{
		Print("[EAI] [state_enter] bot=" + unit.ToString() + " state=eAIState_Fighting_Evade event=" + Event);
	...
	{
		Print("[EAI] [state_exit] bot=" + unit.ToString() + " state=eAIState_Fighting_Evade aborted=" + Aborted);
